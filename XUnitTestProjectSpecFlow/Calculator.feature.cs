...
#line hidden
        ...
        [Xunit.FactAttribute(DisplayName="Add two numbers in Calculator")]
        [Xunit.TraitAttribute("FeatureTitle", "Calculator")]
        [Xunit.TraitAttribute("Description", "Add two numbers in Calculator")]
        [Xunit.TraitAttribute("Category", "mytag")]
        public virtual void AddTwoNumbersInCalculator()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Add two numbers in Calculator", null, new string[] {
                        "mytag"});
#line 7
